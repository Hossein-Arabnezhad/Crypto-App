...
import { CartesianGrid, Line, LineChart, ResponsiveContainer, YAxis, XAxis, Legend, Tooltip } from 'recharts';
    ...
    return (
        <ResponsiveContainer width='100%' height='100%'>
            <LineChart width={400} height={400} data={data}>
                ...
                <Line type='monotone' dataKey={type} stroke='#3774ff' strokeWidth='2px' />
